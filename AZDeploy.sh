docker build -t wealthmanagement:v3 .
docker tag wealthmanagement:v3 apmpacr.azurecr.io/wealthmanagement:v3

az acr login --name apmpacr
docker push apmpacr.azurecr.io/wealthmanagement:v3
